        ...
        <div class="faculty__content">
            ...
            <div class="faculty__program">
                <div class="faculty-program">
                    <h4 class="faculty-program__title">
                        <?php the_field('heading_short_program'); ?>
                    </h4>
                    ...
                    <div class="faculty-program__button">
                        <a class="button" href="<?php the_field('button_link_full_program'); ?>"
                            target="_blank"><?php the_field('button_text_full_program'); ?></a>
                    </div>
                </div>
